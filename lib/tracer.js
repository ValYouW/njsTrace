...
Tracer.prototype.onIfStatement = function(args) {
	console.log(sprintf("%10s %20s %10s", 'IF STATEMENT', args.function_name, args.file_name, args.line));
	//console.log('IF STATEMENT in' + args.file_name + " @ " + args.function_name + "::" + args.line);
