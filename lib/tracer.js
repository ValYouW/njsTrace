...
Tracer.prototype.onEntry = function(args) {
    this.traceOut.write('Enter %s at %s::%s, args:', args.name, args.file, args.line, JSON.stringify(args.args));
...
Tracer.prototype.onExit = function(args) {
    this.traceOut.write('Exit %s at %s::%s, retValue:', args.entryData.name, args.entryData.file, args.line, JSON.stringify(args.returnValue));
};
