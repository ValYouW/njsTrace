...
var json = JSON.stringify(McCabe_statements);
...
//						    S	   P      FN      L      C      EL    EC
	console.log(sprintf("%-12s | %-20s | %-40s | %-9s | %-6s | %-8s | %-9s |", args.statement_type,
		args.function_name.split('@')[1].split(':')[0], args.file_name, args.line, args.column, args.end_line, args.end_column, args.statement_name));
	// TODO Rename function_name to function_id


	// console.log(args.function_name)
