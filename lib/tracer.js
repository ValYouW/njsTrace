...
function Tracer(formatters) {
	...
	this.onEntryArgs = { name: '', file: '', line: 0, args: null, stack: null, timestamp: 0 };
	this.onExitArgs = { name: '', file: '', line: 0, retLine: 0, span: 0, duration: 0, stack: null, exception: false, returnValue: null };
}
...
Tracer.prototype.onExit = function(args) {
	...
	this.onExitArgs.duration = Date.now() - args.entryData.ts
