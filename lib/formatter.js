...
var TRACE_EXIT = '%s%s %s %dms @%s::%s, ts: %s, retLine: %s, retVal: %s';
var TRACE_EXIT_EX = '%s%s %s %dms @%s::%s, EX, ts: %s, retLine: %s, retVal: %s';
...
Formatter.prototype.onExit = function(args) {
	...
	this.output.write(format, this.indentation, prefix, args.name, args.duration, args.file, args.line, args.span, args.retLine, retVal);
};
